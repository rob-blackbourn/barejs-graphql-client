...
class FetchError$1 extends Error {
  ...
  constructor (response, ...params) {
    ...
    if (Error.captureStackTrace) {
      Error.captureStackTrace(this, FetchError$1);
    }
  ...
  fetch(url, init)
    .then(response => {
      if (response.status === 200) {
        ...
        onError(new FetchError$1(response, 'Failed to execute GraphQL'));
      }
    })
    .catch(error => onError(error));
...
export { FetchError$1 as FetchError, graphqlEventSourceClient, graphqlEventSourceSubscriber, graphqlFetchClient, graphqlStreamClient, graphqlWsClient, graphqlWsSubscriber };
